<body class="login-body">
    ...
    <div class="container-fluid login-wrapper">
        <div class="login-box">
            <h1 class="text-center mb-5"><i class="fa fa-rocket text-primary"></i> Simbel</h1>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-12 login-box-info">
                    <h3 class="mb-4">Simbel</h3>
                    <p class="mb-4">Sistem informasi bimbingan belajar adalah sebuah sistem yang mempermudah dalam memanajemen sistem pembelajaran bimbel di ...</p>
                    <p class="text-center"><a href="<?= base_url('Auth/registration') ?>" class="btn btn-light">Register here</a></p>
                </div>
                <div class="col-md-6 col-sm-6 col-12 login-box-form p-4">
                    <h3 class="mb-2">Login</h3>
                    <small class="text-muted bc-description">Masuk dengan Menggunakan akunmu</small>
                    <!-- // -->
